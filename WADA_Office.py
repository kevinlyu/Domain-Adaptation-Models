...
if __name__ == "__main__":
    ...
    source_loader = get_office_loader("amazon", 10)
    target_loader = get_office_loader("dslr", 10)
    test_src_loader = get_office_loader("amazon", 10)
    test_tar_loader = get_office_loader("dslr", 10)

    extractor = Extractor_Office().cuda()
    ...
    components = {"extractor": extractor, "classifier": classifier,
